...
class Post extends \Post\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Post\\Entity\\Post' . "\0" . 'postId', '' . "\0" . 'Post\\Entity\\Post' . "\0" . 'thumbnail', '' . "\0" . 'Post\\Entity\\Post' . "\0" . 'user', '' . "\0" . 'Post\\Entity\\Post' . "\0" . 'title', '' . "\0" . 'Post\\Entity\\Post' . "\0" . 'content', '' . "\0" . 'Post\\Entity\\Post' . "\0" . 'postDate', '' . "\0" . 'Post\\Entity\\Post' . "\0" . 'url');
        }
