 ...
 */
class Attribute extends \Product\Entity\Attribute implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Product\\Entity\\Attribute' . "\0" . 'attributeId', '' . "\0" . 'Product\\Entity\\Attribute' . "\0" . 'name', '' . "\0" . 'Product\\Entity\\Attribute' . "\0" . 'products');
        }
